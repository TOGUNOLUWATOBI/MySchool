...
public class App 
{
    ...
    {
        try {
            System.out.println(objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(CourseDao.getAllCourses()));
    ...
    private static boolean addCourse()
    {
        ...
        if(course != null)
        {
            ...
            Boolean success = CourseDao.addCourse(new Course(courseName, courseCode));
            if (success) {
